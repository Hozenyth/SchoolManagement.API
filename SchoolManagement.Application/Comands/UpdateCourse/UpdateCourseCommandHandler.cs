...
{
    public class UpdateCourseCommandHandler : IRequestHandler<UpdateCourseComand, Unit>
    {
        ...
        public async Task<Unit> Handle(UpdateCourseComand request, CancellationToken cancellationToken)
        {
